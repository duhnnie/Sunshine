package net.duhnnie.android.sunshine.app.sync;
...
import net.duhnnie.android.sunshine.app.BuildConfig;
import net.duhnnie.android.sunshine.app.MainActivity;
import net.duhnnie.android.sunshine.app.R;
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                if (Utility.areNotificacionsEnabled(getContext())) {
                    notifyWeather();
                }
            }
